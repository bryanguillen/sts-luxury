					...
					echo "<div class=\"row\">
						...
						<div class=\"row\">
							<div class=\"col-sm-6 col-sm-offset-3 full-height\">
								...
								<p>
									<input type=\"text\" name=\"name\" class=\"complaint-form-field\" />
								</p>
								<p>
									<label for=\"phone-number\">Phone Number:</label>
								</p>
								<p>
									<input type=\"text\" name=\"phone-number\" class=\"complaint-form-field\" />
								</p>
								<p>
									<label for=\"location\">Location:</label>
								</p>
								<p>
									<input type=\"text\" name=\"location\" class=\"complaint-form-field\" required/>
								</p>
								<p>
									<label for=\"complaint\">Complaint:</label>
								</p>
								<p>
									<textarea name=\"complaint\"  class=\"complaint-form-field\" required></textarea>
								</p>
